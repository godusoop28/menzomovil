...
const styles = StyleSheet.create({
  ...
  profileTouchable: { alignItems: 'center', gap: 2, marginTop: Spacing.sm, width: '100%' },
  name: { ...Typography.h2, color: '#FFFFFF', marginTop: Spacing.sm, textAlign: 'center' },
  status: { ...Typography.caption, color: 'rgba(255,255,255,0.65)', marginBottom: 4, textAlign: 'center' },
  levelRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: Spacing.sm, marginTop: Spacing.xs, width: '100%' },
  ...
  skeletonWrap: { width: '100%', alignItems: 'center', gap: Spacing.sm },
