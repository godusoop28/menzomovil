// Contrato 1:1 con menzoapi (ver menzoapi/README.md). Nombres de campo exactos, case-sensitive.
...
export type UpdateRoomRequest = { coverUri?: string; backgroundUri?: string };
